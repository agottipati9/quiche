...
#ifndef QUICHE_QUIC_CORE_CONGESTION_CONTROL_LLM_SENDER_H_
#define QUICHE_QUIC_CORE_CONGESTION_CONTROL_LLM_SENDER_H_
...
class QUICHE_EXPORT LlmSender : public SendAlgorithmInterface {
 public:
  enum Mode {
  ...
  struct QUICHE_EXPORT DebugState {
    explicit DebugState(const LlmSender& sender);
  ...
  LlmSender(QuicTime now, const RttStats* rtt_stats,
...
QUICHE_EXPORT std::ostream& operator<<(std::ostream& os,
                                       const LlmSender::Mode& mode);
QUICHE_EXPORT std::ostream& operator<<(std::ostream& os,
                                       const LlmSender::DebugState& state);

}  // namespace quic

#endif  // QUICHE_QUIC_CORE_CONGESTION_CONTROL_LLM_SENDER_H_
